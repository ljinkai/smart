...
//    ssl: {
//       ca: require('fs').readFileSync('config/ssl/certrequest.csr'),
//       key: require('fs').readFileSync('config/ssl/privatekey.pem'),
//       cert: require('fs').readFileSync('config/ssl/certificate.pem')
//    },
    ...
    test_user_id :"DAjr5Ykrdb",
    test_user_token : "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjo2OH0.64cxpREeWQtBrE0TWB7TFXL2qj5Ay9-yfLccJAoERlM",

    routes: {
        '/app/sign' : 'AppController.sign'
    }
